...
- Updated omnibar to always connect to the client notification service so consuming applications can receive custom messages. [#184](https://github.com/blackbaud/auth-client/pull/184)
